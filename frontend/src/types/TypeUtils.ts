...
/**
 * Test to see if an interactable is a Note Taking area
 */
export function isNoteTakingArea(interactable: Interactable): interactable is NoteTakingArea {
  return interactable.type === 'NoteTakingArea';
}
